...
exports.servicioDeteccion = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const deteccion_entity_1 = require("../entities/deteccion.entity");
let servicioDeteccion = class servicioDeteccion {
    constructor(modeloDeteccion) {
        this.modeloDeteccion = modeloDeteccion;
    }
    async Crear(validacionDeteccion) {
        try {
    ...
    async Actualizar(id, validacionDeteccion) {
        try {
...
servicioDeteccion = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(deteccion_entity_1.Deteccion.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], servicioDeteccion);
exports.servicioDeteccion = servicioDeteccion;
//# sourceMappingURL=deteccion.service.js.map